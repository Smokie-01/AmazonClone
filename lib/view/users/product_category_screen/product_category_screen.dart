...
class _ProductCategoryScreenState extends State<ProductCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<ProductByCategoryProvider>(
        builder: (context, categoryProductProvider, child) {
          if (categoryProductProvider.isProductFteched == false) {
            return const Center(
              child: Text("Search your product here ..."),
            );
          } else if (categoryProductProvider.products.isEmpty) {
            return const Center(
            ...
            return ListView.builder(
              shrinkWrap: true,
              itemCount:
                  context.read<ProductByCategoryProvider>().products.length,
              itemBuilder: (context, index) {
                ProductModel currentProduct =
                    categoryProductProvider.products[index];
                if (categoryProductProvider.isProductFteched == false) {
