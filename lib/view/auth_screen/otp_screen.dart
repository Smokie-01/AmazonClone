...
class _OTPScreenState extends State<OTPScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              ...
              TextSpan(
                  text: widget.mobileNumber, style: textTheme.displayMedium),
              TextSpan(
                  text: ' Change',
  ...
  CommonFunction.blankSpace(height * .02, 0), 
 CommonAuthButton(title: "Verify ", onPressed:(){}),
           CommonFunction.blankSpace(height * .03, 0), 
          TextButton(onPressed: (){}, child: Text("Resend OTP", style: textTheme.bodySmall!.copyWith(color: blue),)),
          ],
        ),
      )),
    );
